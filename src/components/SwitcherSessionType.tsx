...
const SwitcherTwo = () => {
  ...
  const [sessionTypeSession, setSessionTypeSession] = useState('');


  //console.log( 'setSessionTypeSession='+sessionTypeSession );
  ...
  return (
    <div x-data="{ switcherToggle: false }">
        ...
        <div className="relative">
          <input
            ...
            onChange={() => {
              setEnabled(!enabled);
              if (!enabled) {
                setSessionTypeSession("0");
              }else{
                setSessionTypeSession("1");
              }
            }}
          />
      ...
      <input type="hidden" name="sessionType" value={sessionTypeSession} />
    </div>
