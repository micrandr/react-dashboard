...
import User1 from '../images/user/user-01.jpg';
import User2 from '../images/user/user-02.jpg';
import User3 from '../images/user/user-08.jpg';
import User4 from '../images/user/user-04.jpg';
import Swal from 'sweetalert2';

const API_USER_URL = '/users';

const DataListUsersBack = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      {users.map( (user, index)=> {
        ...
        const UserFicheLink = '/users/fiche/' + user.id;

      return  (

      <div key={user.id} id="item-user-{user.id}" className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        <div className="col-span-3 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="h-12.5 w-15 rounded-md hidden">
        ...
        <div className="col-span-2 flex items-center">
          <p className="text-sm text-black dark:text-white">{user.userEmail}</p>
        </div>
        <div className="col-span-1 flex items-center">
...
export default DataListUsersBack;
